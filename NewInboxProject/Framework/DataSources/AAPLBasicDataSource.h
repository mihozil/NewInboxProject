...
@interface AAPLBasicDataSource <CollectionItemType : id> : AAPLDataSource<CollectionItemType>
 ...
 */
@property (nonatomic, copy) NSArray<CollectionItemType> *items;
 ...
 */
- (void)setItems:(NSArray<CollectionItemType> *)items animated:(BOOL)animated;
