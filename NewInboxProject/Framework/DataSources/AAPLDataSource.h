 ...
 */
@interface AAPLDataSource <CollectionItemType : id> : NSObject <UICollectionViewDataSource, AAPLContentLoading>
...
- (nullable CollectionItemType)itemAtIndexPath:(NSIndexPath *)indexPath;

/// Find the index paths of the specified item in the data source. An item may appear more than once in a given data source.
- (NSArray<NSIndexPath *>*)indexPathsForItem:(CollectionItemType)item;
...
// minhnht added
- (void)notifyWillUpdateItems:(NSArray*)newItems;
//- (void)notifyItems
