...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    AAPLCollectionViewLayout *flowLayout = [[AAPLCollectionViewLayout alloc]init];
    
    InboxCollectionViewController *inboxVC = [[InboxCollectionViewController alloc]initWithCollectionViewLayout:flowLayout];
